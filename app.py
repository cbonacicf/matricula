...
def modifica_seleccion(tipo, matricula, genero, nivel, region, area, stem, var_local, tipo_graf):
    crt_local = crea_criterio(tipo, matricula, genero, nivel, region, area, stem)
